...
> 2026-09-15 C1 更新：修正后的三种子 MOSEI validation 审计已完成。视觉分数与负 KL 的 Spearman 为 `-0.315423±0.069633`，音频为 `0.092174±0.042066`；视觉跨样本目标保真度被否定，音频仅获弱支持。下文关于“C1 尚未运行”的记录是本次服务器结果之前的审计快照。
