...
from models.trans.position_embedding import SinusoidalPositionalEmbedding
from models.trans.multihead_attention import MultiheadAttention
import math
...
class TransformerEncoderLayer(nn.Module):
    def __init__(self, embed_dim, num_heads=4, attn_dropout=0.1, 
        ...
        self.res_drop = nn.Dropout(self.res_dropout)
        self.relu_drop = nn.Dropout(self.relu_dropout)
