...
This draft has five primary empirical limitations. First, MOSI test-split
...
Third, the reliability intervention uses pre-extracted features and synthetic
Gaussian corruption. Fourth, the final P4 multi-seed study currently includes
only Learned and Constant; the complete permuted, reversed, and oracle suite
has not yet been repeated under the final schedule. Fifth, baseline loss is
unavailable, preventing a complete loss comparison with repaired MFON.
