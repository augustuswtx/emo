...
\item
  ...
  three-seed CMU-MOSEI replication, then use Gaussian, timestep-dropout,
...
offsets across speakers or content. The pending cross-sample calibration audit
therefore measures score--target-fidelity association, stratified consistency,
and residual length/energy dependence; until it is completed, the implication
above is a testable design premise, not an empirical result.
...
text-dominant inference, unverified cross-sample score calibration,
