...
seed-1111 acoustic encoder is complete and visual encoder training is
running, so no MOSEI performance is reported. CH-SIMS and additional
backbones remain planned. We do not use
...
weights. Server-side tests pass, the seed-1111 acoustic encoder is
complete, and visual encoder training is running. The remaining order is
to complete the visual encoder, run a two-epoch P4 Learned smoke test
with checkpoint reload, and only then conduct a frozen seed-1111
comparison of repaired MFON, P4 Constant, and P4 Learned. No MOSEI
number is included in this manuscript until those gates complete.
