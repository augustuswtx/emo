...
seed-1111 acoustic and visual encoders are complete, while the fusion
smoke test has not yet passed, so no MOSEI performance is reported.
...
weights. Server-side tests pass, and the seed-1111 acoustic and visual
encoders are complete. The remaining order is to run a two-epoch P4
Learned smoke test with checkpoint reload, and only then conduct a
frozen seed-1111 comparison of repaired MFON, P4 Constant, and P4
Learned. No MOSEI number is included in this manuscript until those
gates complete.
