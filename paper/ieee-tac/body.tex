...
seed-1111 acoustic and visual encoders and two-epoch fusion smoke
training are complete, while checkpoint reload testing remains pending,
...
training-side budget, reliability-gap, clean-task-path, and
checkpoint-save gates. Checkpoint reload testing remains pending; only
after it passes will we conduct a frozen seed-1111 comparison of
repaired MFON, P4 Constant, and P4 Learned. No MOSEI number is included
in this manuscript until those gates complete.
