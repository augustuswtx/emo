...
> 推理为 1024.97 ms/批、31.22 样本/s、峰值 1.136 GiB；前向+反向为 1120.03 ms/批、
> 峰值 4.805 GiB。P4 相对 baseline 新增 30,914 个优化参数（0.02364%），Learned 的
> 前向+反向延迟与峰值训练显存分别高 0.71% 和 0.29%，推理峰值与 checkpoint 大小不变。
